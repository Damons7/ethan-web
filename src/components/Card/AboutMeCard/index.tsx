...
export const AboutMeCard = (props: NativeProps) => {
    const {
        title = 'About Me',
        className,
        headerClassName,
    ...
    return (
        <Card title={title}
            className={className}
            headerClassName={`${headerClassName} aboutme-card-header`}
	...
	c-0.007,0.007-0.015,0.014-0.021,0.02C71.666,63.771,71.892,63.307,71.916,62.782z"/>
                    ...
                    <path fill="#FCEFED" stroke="#FEEBE6"
                        strokeMiterlimit="10" d="M116.279,55.814c-0.021-0.286-2.323-28.744-30.221-41.012
	...
	c7.636,0,15.336,1.684,22.887,5.004c26.766,11.771,29.011,39.047,29.027,39.251V121.405z"/>
                ...
                <p className="shadowFrame"><svg version="1.1" className="shadow" id="Layer_1"
                    ...
                    xmlSpace="preserve">
                    <ellipse fill="#888" cx="61.128" cy="19.872" rx="49.25" ry="8.916" />
                </svg></p>
            </div>
        </Card>
    )
